...
public class NoteEditor extends Activity {
    ...
    private static final String[] PROJECTION =
        new String[] {
            ...
            NotePad.Notes.COLUMN_NAME_NOTE,
                //NotePad.Notes.COLUMN_NAME_TEXT_COLOR,//增加颜色的存储
               // NotePad.Notes.COLUMN_NAME_TEXT_SIZE,//增加文本大小的存储
    };
    ...
    //View txt= (View)findViewById(R.id.note);
   // TextView txt = (TextView)findViewById(R.id.note);
//    PreferenceActivity preferenceActivity = new PreferenceActivity() {    //prefereceFragment做不出来
//
//    };

//    //修改字体颜色
//    int x = mCursor.getInt(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TEXT_COLOR));
//
//    switch(x){
//        case NotePad.Notes.TEXT_COLOR_BLACK:
//            mText.setTextColor(Color.BLACK);
//            break;
//        case NotePad.Notes.TEXT_COLOR_PINK:
//            mText.setTextColor(Color.rgb(249,12,235));
//            break;
//
//        default:
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_save:
            ...
            updateNote(text, null);
            finish();
            Toast toast6 =Toast.makeText(NoteEditor.this,"保存成功",Toast.LENGTH_SHORT);
            toast6.show();
            break;
        case R.id.menu_delete:
            deleteNote();
            finish();
            Toast toast7 =Toast.makeText(NoteEditor.this,"删除成功",Toast.LENGTH_SHORT);
            toast7.show();
            break;
