...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        public static final int TEXT_COLOR_BLACK = 0; //白
        public static final int TEXT_COLOR_PINK = 1; //黄
        public static final int TEXT_COLOR_YELLOW = 2; //蓝
        public static final int TEXT_COLOR_RED = 3; //绿
        public static final int TEXT_COLOR_BLUE = 4; //红

        public static final String COLUMN_NAME_TEXT_SIZE = "size";//新增加的修改字体大小
        public static final int TEXT_SIZE_10 = 0; //白
        public static final int TEXT_SIZE_20 = 1; //黄
        public static final int TEXT_SIZE_30 = 2; //蓝
        public static final int TEXT_SIZE_40 = 3; //绿
        public static final int TEXT_SIZE_50 = 4; //红
    }
}
